...
AWS EKS uses [CNI](https://github.com/nholuongut/aws-vpc-cni-k8s networking plugin for pod networking in Kubernetes using Elastic Network Interfaces on AWS
